        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="https://flowbite.com" class="flex items-center">
                    <img src="/little-kids/public/boy.png" class="mr-3 h-6 sm:h-9" alt=" Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">ลิตเติ้ลคิดส์</span>
                </a>
                <div class="flex items-center lg:order-2">
                    <a href="login.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">เข้าสู่ระบบ</a>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl ">สถานรับเลี้ยงเด็กอนุบาลลิตเติ้ลคิดส์</h1>
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="/little-kids/public/3.png" alt="mockup">
            </div>
        </div>
    </section>
