                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    <div class="px-6 py-6 w-full border-2 border-gray-200 rounded-3xl">
                        ...
                        <div class="flex items-center justify-between mb-8">
                            <h6 class="font-light text-gray-400 text-sm md:text-lg">เริ่ม : <span class="font-semibold text-gray-900 text-md md:text-lg">$25000</span></h6>
        
                            <h6 class="font-light text-gray-400 text-sm md:text-lg">สิ้นสุด : <span class="font-semibold text-gray-900 text-md md:text-lg">$21000</span></h6>
                        </div>
