...
<head>
    ...
    <title>แก้ไขข้อมูลผู้อำนวยการ</title>
                        ...
                        <form action="insert_director.php" method="post">
                            <div class="md:flex items-center mt-4">
                                ...
                                <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0">
                                    ...
                                    <input type="password" name="password" value="<?= $user['password']; ?>" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200" />
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-center w-full gap-4">
                                ...
                                <a href="director_manage.php" class="mt-9 font-semibold leading-none text-white py-4 px-10 bg-red-600 rounded hover:bg-red-600 focus:ring-2 focus:ring-offset-2 focus:ring-red-700 focus:outline-none">ยกเลิก</a>
                            </div>
                        </form>
                    </div>
                </div>
