                        ...
                        <form action="insert_room.php" method="post">
                            <div class="md:flex items-center mt-4">
                                <div class="w-full flex flex-col">
                                    ...
                                    <input type="text" name="room_name" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200" />
                                </div>
                            </div>
