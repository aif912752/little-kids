                                ...
                                <div class="bg-white w-full shadow rounded p-8 sm:p-12 -mt-72">
                                    ...
                                    <form action="insert_student.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="flex items-center justify-center w-full gap-4">
                                            ...
                                            <a href="room_view.php?id=<?= $room_id ?>" class="mt-9 font-semibold leading-none text-white py-4 px-10 bg-red-600 rounded hover:bg-red-600 focus:ring-2 focus:ring-offset-2 focus:ring-red-700 focus:outline-none">ยกเลิก</a>
