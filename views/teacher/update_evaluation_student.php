...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE evaluation_students SET evaluation_name = ? WHERE evaluation_id = ?";
    ...
    if ($stmt->execute()) {
        ...
        foreach ($questions as $question_id => $question) {
            ...
            // อัปเดตคำถาม
            $sql_question = "UPDATE evaluation_activity_student SET evaluation_name = ? WHERE id = ?";
            ...
            // อัปเดตคะแนนในตาราง evaluation_activity_student
            $sql_update_score = "UPDATE evaluation_activity_student SET evaluation_score = ? WHERE id = ?";
...
window.location.href = 'evaluation_student.php'; // เปลี่ยนเส้นทางไปยัง evaluation.php
</script>";
} else {
